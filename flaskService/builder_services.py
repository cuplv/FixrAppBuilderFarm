...
from config import get_configs, default_configs, load_configs
...
def db_update_repo_record(repo_record, stat, snippet, app_updates):
    return update_repo_record(repo_record, stat, snippet, app_updates, config=CONFIGS['db'])
...
============================================================================================''' % (CONFIGS['redis']['host'],CONFIGS['redis']['port'],CONFIGS['redis']['builder'],CONFIGS['redis']['jobs'])
    ...
    while True:
       ...
       if new_job != None:
           ...
           try:
               repoProcessor.processFromDB( [repo] )
           except Exception, e:
